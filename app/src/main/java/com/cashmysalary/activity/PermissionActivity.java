...
import com.cashmysalary.adapter.PermissionAdapter;
import com.cashmysalary.model.PermissionModel;
...
public class PermissionActivity extends AppCompatActivity {
    ...
    private void fetchPermissionList() {
        ...
        permissionModel6.icon = R.drawable.ic_phone_;
        ...
        permissionModel8.icon = R.drawable.ic_photo_camera_black_24dp;
...
//        try{
//            String json = Util.getAssetJsonResponse(mContext,"PermissionList.json");
...
//                PermissionModel permissionModel = new PermissionModel();
//                permissionModel.title = jsonObject1.optString("title");
//                permissionModel.description = jsonObject1.optString("description");
//                permissionModels.add(permissionModel);
//            }
//        }catch (Exception e){
//            e.printStackTrace();
