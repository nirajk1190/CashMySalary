...
public class CongratulationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_congratulaions);
        mContext = this;
    ...
    private void applyInit() {
        ...
        toolbar.setTitle(getResources().getString(R.string.congratulation_toolbar_title));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnNext) {
            startActivity(new Intent(mContext, RepaymentDetailsActivity.class));
        }
    }
