...
public class BankDetailsForLoanActivity extends AppCompatActivity implements View.OnClickListener {
    private Context mContext;
    private AppCompatButton btnNext, btnPrevious;
    private static final String TAG = BankDetailsForLoanActivity.class.getSimpleName();
    public static final int REQUEST_IMAGE = 100;
    private ImageView ivCheque,ivChequeCamera;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bank_details_for_loan);
        mContext = this;
        Intent i = getIntent();
        if(i!=null){
    ...
    private void init() {
        ...
        ivCheque = findViewById(R.id.ivCheque);
        ivChequeCamera = findViewById(R.id.ivChequeCamera);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnPrevious) {
            Intent i = new Intent(mContext,OfficeAddressActivity.class);
            i.putExtra("isReview",isReview);
            startActivity(i);
            overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
            finish();
        }if (v.getId()==R.id.ivCheque){
            onImageClick();
    ...
    public void onImageClick() {
        Dexter.withActivity(BankDetailsForLoanActivity.this)
    ...
    private void loadProfile(String url) {
        ...
        ivChequeCamera.setVisibility(View.GONE);
        Glide.with(this).load(url)
                .into(ivCheque);
        ivCheque.setColorFilter(ContextCompat.getColor(mContext, android.R.color.transparent));
