...
public class InviteFriendAdapter extends RecyclerView.Adapter<InviteFriendAdapter.ItemViewHolder> implements Filterable {
    ...
    public InviteFriendAdapter(Context mContext, ArrayList<ContactDataModel> contactDataModelArrayList,ItemClick itemClick) {
    ...
    @Override
    public InviteFriendAdapter.ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.invite_friend_data, null);
        return new InviteFriendAdapter.ItemViewHolder(v);
    }

    @Override
    public void onBindViewHolder(InviteFriendAdapter.ItemViewHolder holder, final int position) {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView icon_text,tvName,tvMobile,tvInvite;
